var SchematicGradientArray =[]

function findSchematicGradients()
{
    ...
    for(var k = 0; k<gradients.length; k++)
    {
        ...
        SchematicGradientArray.push(gradient)
...
function buildGradientTable()
{
    ...
    for(var k = 0; k<SchematicGradientArray.length; k++)
    {

        var gradient = SchematicGradientArray[k]
